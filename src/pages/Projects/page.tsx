...
const Project: React.FC = () => {
  ...
  const filteredBlogs =
    category === "All"
      ? caseStudies
      : caseStudies.filter((data) => data.Introduction.category === category);
  return (
    <section className="bg-secondary text-primary">
      <div className="">
        ...
        <div className="px-5 pb-10 mb-10 grid gap-6 md:grid-cols-3 max-w-6xl mx-auto">
            ...
            return (
              ...
              >
                <div className="flex flex-col gap-2 mt-2">
                  ...
                  <p>
                    <span className="bg-primary/20 text-sm font-semibold text-primary px-2 py-1 rounded-sm ">
                      {study.impact}
                    </span>
                  </p>
                </div>
